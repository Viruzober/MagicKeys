...
public static void IniDeleteKey(string IniFile, string Section, string Key)
{
...
int KeyIndex = SectionIndex + RangeKeys.IndexOf(CheckKey[0]) + 1;
FileStrings.RemoveAt(KeyIndex);
