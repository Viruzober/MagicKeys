...
{
string VUIPath = API.GetVUIPath()+API.GetVUI().Substring(0, API.GetVUI().Length - 4)+"Load.vui";
...
{
string VUFPath = API.GetVUIPath()+API.GetVUI().Substring(0, API.GetVUI().Length - 4)+"Load.vuf";
