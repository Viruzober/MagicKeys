...
if (To == "Back")
{
int[] OUP = ImageSearchArea("BP", Coords.X+10, Coords.Y+160, Coords.X+50, Coords.Y+185, 20);
if (OUP[0] == 1)
{
...
{
int[] ODW = ImageSearchArea("BP", Coords.X+10, Coords.Y+360, Coords.X+50, Coords.Y+385, 20);
if (ODW[0] == 1)
{
