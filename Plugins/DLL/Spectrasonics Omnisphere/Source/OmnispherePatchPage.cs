...
if (To == "Back")
{
int[] FH = ImageSearchArea("FullHome", Coords.X+230, Coords.Y+380, Coords.X+270, Coords.Y+420, 20);
if (FH[0] == 1)
{
SoundPlay("End", false);
return;
...
{
int[] FH = ImageSearchArea("FullEnd", Coords.X+230, Coords.Y+590, Coords.X+270, Coords.Y+630, 20);
if (FH[0] == 1)
{
SoundPlay("End", false);
return;
...
Thread.Sleep(600);
int[] OBP = ImageSearchArea("BP", Coords.X+10, Coords.Y+390, Coords.X+50, Coords.Y+620, 20);
