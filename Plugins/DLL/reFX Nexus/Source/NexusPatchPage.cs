...
if (To == "Back")
{
int[] FH = ImageSearchArea("FullHome", Coords.X+540, Coords.Y+50, Coords.X+590, Coords.Y+160, 20);
if (FH[0] == 1)
{
SoundPlay("End", false);
return;
...
{
int[] FH = ImageSearchArea("FullEnd", Coords.X+540, Coords.Y+180, Coords.X+590, Coords.Y+280, 20);
if (FH[0] == 1)
{
SoundPlay("End", false);
return;
